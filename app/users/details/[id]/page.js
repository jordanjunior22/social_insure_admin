  ...
  return (
    <AdminLayout title='User > Details'>
        ...
        <div className='flex border w-1/2 bg-white rounded-md hover:shadow-md hover:shadow-[#18B8A8] items-center'>
            ...
            <input type='text' className='flex-1 px-1 outline-none rounded-r-md' value={firstName} onChange={(ev)=>{setfirstName(ev.target.value)}} readOnly={true}/>
        </div>

        <div className='flex border w-1/2 bg-white rounded-md hover:shadow-md hover:shadow-[#18B8A8] items-center'>
            <p className='flex-2 bg-[#18B8A8] text-white font-bold p-2 rounded-l-md text-sm'>First Name</p>
            <input type='text' className='flex-1 px-1 outline-none rounded-r-md' value={lastName} onChange={(ev)=>{setlastName(ev.target.value)}} readOnly={true}/>
        </div>
        ...
        <div className='flex border bg-white w-1/2 rounded-md hover:shadow-md hover:shadow-[#18B8A8] items-center'>
            ...
            <input type='text' className='flex-1 px-1 outline-none rounded-r-md' value={email} onChange={(ev)=>{setEmail(ev.target.value)}} readOnly={true}/>
        </div>
        <div className='flex border w-1/2 bg-white rounded-md hover:shadow-md hover:shadow-[#18B8A8] '>
            ...
            <input className='flex-1 px-1 outline-none rounded-r-md' type='text' value={phoneNumber} onChange={(ev)=>{setPhoneNumber(ev.target.value)}} required={true} readOnly={true}/>
        </div>

        <div className='flex border w-1/2 bg-white rounded-md hover:shadow-md hover:shadow-[#18B8A8]'>
            <p className='flex-2 bg-[#18B8A8] text-white font-bold p-2 rounded-l-md text-sm'>Well Being Subscriber</p>
            <input className='flex-1 px-1 outline-none rounded-r-md' type='text' value={isAWellBeingSubscriber} onChange={(ev)=>{setIsAWellBeingSubscriber(ev.target.value)}} required={true} readOnly={true}/>
        </div>
        ...
        <div className='flex border w-1/2 bg-white rounded-md hover:shadow-md hover:shadow-[#18B8A8]'>
            ...
            <input className='flex-1 px-1 outline-none rounded-r-md' type='text' value={balance} onChange={(ev)=>{setBalance(ev.target.value)}} required={true} readOnly={true}/>
        </div>
